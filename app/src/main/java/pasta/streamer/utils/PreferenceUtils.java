...
public class PreferenceUtils {
    ...
    final public static String ORDER = "order", PRELOAD = "preload", DEBUG = "debug", LIMIT = "limit", THUMBNAILS = "thumbnails", QUALITY = "playback_quality";
    final public static int ORDER_ADDED = 0, ORDER_NAME = 1, ORDER_ARTIST = 2, ORDER_ALBUM = 3, ORDER_LENGTH = 4, ORDER_RANDOM = 5;
    final private static String RETRY = "retry";
    ...
    public static int getColumnNumber(boolean landscape) {
        int columns = 2;
