...
public class HomeActivity extends AppCompatActivity {
    ...
    public static AccountHeader materialHeader;
    public static Fragment f;
    public static long selected;
    public static String title;
    public static Map<String, Object> limitMap;
    public static Pool searchPool;
    public static ArrayList searchDatas;
    ...
    public FrameLayout statusBackground;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Drawable music = ImageUtils.getVectorDrawable(this, R.drawable.ic_music);
        ...
        DrawableCompat.setTint(music, tint);
        ...
        DrawerBuilder builder = new DrawerBuilder()
                ...
                .withSelectedItem(1)
                .addDrawerItems(
                        new SecondaryDrawerItem().withName("Home").withIdentifier(15).withIcon(home),
                        new SecondaryDrawerItem().withName(R.string.title_activity_home).withIdentifier(1).withIcon(music),
                ...
                .withOnDrawerItemClickListener(new com.mikepenz.materialdrawer.Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch (((int) drawerItem.getIdentifier())) {
                            case 15:
                                startActivity(new Intent(HomeActivity.this, com.example.jakegrace.exercyse.HomeActivity.class));
                                return true;
                            case 1:
                                f = new HomeFragment();
                        ...
                        if (drawer_layout != null) drawer_layout.closeDrawer(Gravity.START);
                        return true;
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
         if (item.getItemId() == android.R.id.home) {
             if (drawer_layout != null && drawer_layout.getDrawerLockMode(Gravity.START) != DrawerLayout.LOCK_MODE_LOCKED_CLOSED)
