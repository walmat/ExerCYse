...
public class PlaylistFragment extends FullScreenFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recycler.setLayoutManager(new GridLayoutManager(getContext(), PreferenceUtils.getColumnNumber(metrics.widthPixels > metrics.heightPixels)));
        recycler.setHasFixedSize(true);

        //TODO - this is exactly what NATE needs
