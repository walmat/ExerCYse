    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        switch (getItemViewType(holder.getAdapterPosition())) {
            ...
            case 1:
                ...
                ((TextView) holder.v.findViewById(R.id.extra)).setText(String.format(Locale.US, "%d %s", albumData.tracks, albumData.tracks == 1 ? "track" : "tracks"));
            ...
            case 2:
                ...
                ((TextView) holder.v.findViewById(R.id.extra)).setText(String.format(Locale.US, "%d %s", playlistData.tracks, playlistData.tracks == 1 ? "track" : "tracks"));
