...
public class AcceptReportActivity extends AppCompatActivity {
    ...
    private void setTvEquipment() {
        TextView tvEquipment = (TextView)findViewById(R.id.txt_Equip);
    ...
    private void setTvFloor() {
        TextView tvFloor = (TextView)findViewById(R.id.txt_Flr);
    ...
    private void setTvNotes() {
        TextView tvNotes = (TextView)findViewById(R.id.txt_nts);
    ...
    private void setUpRequest() {
            ...
            public void onResponse(String s) {
                try {
                    ...
                    if(response.getBoolean("success")) {
                        Intent leave = new Intent(AcceptReportActivity.this, ReportsHomeActivity.class);
                        startActivity(leave);
                        finish();
                    } else {
        ...
        params.put("toggle", "acceptReport");
